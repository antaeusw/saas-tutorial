...
#if debug is true, add localhost and 127.0.0.1 to allowed hosts
if DEBUG:
...
ACCOUNT_EMAIL_SUBJECT_PREFIX = "EnergyCenter"
...
#If you need to upload files then use django-storages instead of whitenoise
STORAGES = {
    "staticfiles": {
